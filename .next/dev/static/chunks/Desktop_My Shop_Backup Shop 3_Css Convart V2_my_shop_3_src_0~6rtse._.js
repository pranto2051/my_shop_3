...
"[project]/Desktop/My Shop/Backup Shop 3/Css Convart V2/my_shop_3/src/app/search/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SearchResults() {
    ...
    const searchParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"])();
    const query = searchParams.get('q') || '';
    const categoryId = searchParams.get('categoryId') || '';
    const minPrice = searchParams.get('minPrice') || '';
    const maxPrice = searchParams.get('maxPrice') || '';
    const sort = searchParams.get('sort') || '';
    const [results, setResults] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
        ...
        "SearchResults.useEffect": ()=>{
            ...
            if (query) {
                ...
                filtered = filtered.filter({
                    "SearchResults.useEffect": (p)=>{
                        const idMatch = p.id.toLowerCase() === q;
                        const nameMatch = p.name.toLowerCase().includes(q);
                        const nameEnMatch = p.nameEn?.toLowerCase().includes(q);
                        const tagMatch = p.tags && p.tags.some({
                            "SearchResults.useEffect": (t)=>t.toLowerCase().includes(q)
                        }["SearchResults.useEffect"]);
            ...
            if (categoryId && categoryId !== 'all') {
                filtered = filtered.filter({
                    "SearchResults.useEffect": (p)=>p.categoryId === categoryId
                }["SearchResults.useEffect"]);
            }
            if (minPrice) {
                filtered = filtered.filter({
                    "SearchResults.useEffect": (p)=>p.price >= parseInt(minPrice)
                }["SearchResults.useEffect"]);
            }
            if (maxPrice) {
                filtered = filtered.filter({
                    "SearchResults.useEffect": (p)=>p.price <= parseInt(maxPrice)
                }["SearchResults.useEffect"]);
            }
            switch(sort){
                case 'price_asc':
                    filtered.sort({
                        "SearchResults.useEffect": (a, b)=>a.price - b.price
                    }["SearchResults.useEffect"]);
                    break;
                case 'price_desc':
                    filtered.sort({
                        "SearchResults.useEffect": (a, b)=>b.price - a.price
                    }["SearchResults.useEffect"]);
                    break;
                case 'popular':
                    filtered.sort({
                        "SearchResults.useEffect": (a, b)=>(b.reviewCount || 0) - (a.reviewCount || 0)
                    }["SearchResults.useEffect"]);
                    break;
                default:
                    filtered.sort({
                        "SearchResults.useEffect": (a, b)=>b.id.localeCompare(a.id)
                    }["SearchResults.useEffect"]);
            }
            setResults(filtered);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container",
                    children: query ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        children: [
                            '"',
                            query,
                            '" এর জন্য ',
                        ...
                        lineNumber: 89,
                        columnNumber: 13
                    }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        children: [
                            "সকল পণ্য — ",
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "result-number",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        action: "/search",
                        method: "GET",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "container",
                children: results.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(SearchResults, "uIH8T5IznScDl9rH08obyrlfV44=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"]
    ];
});
_c = SearchResults;
function SearchPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Suspense"], {
                fallback: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container",
                    style: {
                        padding: '100px 20px',
                        textAlign: 'center'
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$My__Shop$2f$Backup__Shop__3$2f$Css__Convart__V2$2f$my_shop_3$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(SearchResults, {}, void 0, false, {
                    fileName: "[project]/Desktop/My Shop/Backup Shop 3/Css Convart V2/my_shop_3/src/app/search/page.js",
                    lineNumber: 188,
                    columnNumber: 9
                }, this)
...
//# sourceMappingURL=Desktop_My%20Shop_Backup%20Shop%203_Css%20Convart%20V2_my_shop_3_src_0~6rtse._.js.map