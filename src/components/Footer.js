    ...
    <>
      <footer className="site-footer">
          ...
          <div className="container">
            <div className="footer-grid">
              <div className="footer-col">
                ...
                <p className="footer-about">{storeInfo.showroomAddress.address.split(',')[0]}, ঢাকার সেরা ফার্নিচার শোরুম। আমরা ২০+ বছর ধরে মানসম্পন্ন আসবাবপত্র সরবরাহ করে আসছি।</p>
        ...
        <div className="footer-bottom">
          <div className="container">
            <p>&copy; {new Date().getFullYear()} {storeInfo.name} | সর্বস্বত্ব সংরক্ষিত</p>
            <p className="dev-credit">Developed with <i className="fas fa-heart"></i> for Quality Furniture</p>
          </div>
        </div>
      </footer>
    </>
